        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-sm text-sm sm:text-base">
              Cyber Security Engineer specializing in enterprise infrastructure protection, advanced network routing architectures, and hardened perimeter defense systems.
            </p>
          </div>

          <div className="flex flex-col md:items-end gap-4">
            <h4 className="font-semibold text-foreground text-sm font-mono tracking-wider">CONNECT NODE</h4>
            <div className="flex flex-wrap gap-4">
              <Link 
                href="https://github.com/Yoseph-Marie" 
                target="_blank" 
                className="p-2 rounded-full bg-background border border-border hover:border-primary hover:text-primary hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 flex items-center justify-center"
              >
                <svg
                  className="size-5"
                  viewBox="0 0 24 24"
